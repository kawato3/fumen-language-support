...
const settingExamples: [string, string, string][] = [
  ...
  ['top-level PARAM keys, with stable unknown keys',
    '%PARAM={"z":0,"chord_suffix_style":"inline","augmented_label":"aug","major_label":"M","a":1,"half_diminished_label":"m7-5","minor_label":"m","paper_height":1100,"diminished_label":"dim","paper_width":800}',
    '%PARAM={"paper_width":800,"paper_height":1100,"minor_label":"m","major_label":"M","diminished_label":"dim","half_diminished_label":"m7-5","augmented_label":"aug","chord_suffix_style":"inline","z":0,"a":1}'],

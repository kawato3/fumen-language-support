...
Baba, MIT (see `resources/vendor/FUMEN-LICENSE.txt`). This is not an official translation.

| Component | License text included in this package |
| --- | --- |
| Fumen — Copyright 2020 Hiroyuki Baba | [MIT](FUMEN-LICENSE.txt) |
| Embedded Fumen/Bravura music symbols — Copyright 2015 Steinberg Media Technologies GmbH, 2020 Hiroyuki Baba | [SIL Open Font License 1.1](OFL.txt) |
| @babel/polyfill 7.8.7 (inside the upstream bundle) | [MIT](BABEL-LICENSE.txt) |
| core-js 2.6.11 (inside the upstream bundle) | [MIT](CORE-JS-LICENSE.txt) |
| regenerator-runtime 0.13.11 (inside the upstream bundle) | [MIT](REGENERATOR-LICENSE.txt) |
| webpack 5.78.0 (generated bootstrap/runtime inside the upstream bundle) | [MIT](WEBPACK-LICENSE.txt) |
